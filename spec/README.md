...
actually true as of **v0.0.55**, audited by running the compiler — not by
...
| [M4 Self-Hosting](M4-SELF-HOSTING.md) | **Phases 1–3 DONE** (v0.0.51–54) — the front end parses itself | The staging, with measured sizes: ~10–12.5k lines of Burxt for stage-1, a textual-LLVM-IR backend, six phases, and the public milestone at the end of phase 4. |
