...
| **v0.0.69–v0.0.92** | The mark, the shape of the repository, the fixpoint, the compiler's own speed, and the ergonomics | [read](docs/log/08-the-mark-and-the-tree.md) |
