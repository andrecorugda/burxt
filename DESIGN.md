...
| **v0.0.69–v0.0.95** | The mark, the shape of the repository, the fixpoint, the compiler's own speed, the ergonomics, generics, no null, and the grammar swept against the bar | [read](docs/log/08-the-mark-and-the-tree.md) |
