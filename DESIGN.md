...
| **v0.0.69–v0.0.90** | The mark, the shape of the repository, the fixpoint, and the compiler's own speed | [read](docs/log/08-the-mark-and-the-tree.md) |
