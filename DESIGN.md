...
| **v0.0.69–v0.0.94** | The mark, the shape of the repository, the fixpoint, the compiler's own speed, the ergonomics, generics, and no null | [read](docs/log/08-the-mark-and-the-tree.md) |
