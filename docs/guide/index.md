...
title: The guide
section: guide
description: Eleven pages in reading order. Each explains a decision and the reasoning behind it.
---

# The guide

Eleven pages, in reading order. Each one explains a **decision** and the reasoning behind it — what
...
<li><a href="03-types.html"><span class="n">3</span> <span>Types</span> <span class="what">Records, enums, interfaces, <code>dynamic</code>, value semantics</span></a></li>
...
<li><a href="08-generics.html"><span class="n">8</span> <span>Generics</span> <span class="what">Type parameters, bounds, why nothing is erased</span></a></li>
<li><a href="09-absence-and-failure.html"><span class="n">9</span> <span>Absence and failure</span> <span class="what"><code>Option</code>, <code>Result</code>, <code>?</code>, and no null</span></a></li>
<li><a href="10-maps.html"><span class="n">10</span> <span>Maps</span> <span class="what">Insertion order, <code>Equatable</code> keys, <code>get</code> and <code>find</code></span></a></li>
