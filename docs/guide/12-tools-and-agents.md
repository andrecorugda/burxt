...
[Practices](13-practices.md) — where a contract belongs and where it does not, and the traps this
project has already paid for. It is the shortest page here and the one that saves the most time.
