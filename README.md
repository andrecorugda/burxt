...
Every push runs **74 invariants**, including that fixpoint, the differential test, 145 pass and 294 fail fixtures, and performance ratios that fail if a known quadratic returns.
