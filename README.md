...
Every push runs **72 invariants**, including that fixpoint, the differential test, 143 pass and 274 fail fixtures, and performance ratios that fail if a known quadratic returns.
