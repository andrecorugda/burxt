...
Every push runs **74 invariants**, including that fixpoint, the differential test, 144 pass and 276 fail fixtures, and performance ratios that fail if a known quadratic returns.
