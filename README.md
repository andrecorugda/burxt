...
Every push runs **68 invariants**, including that fixpoint, the differential test, 142 pass and 269 fail fixtures, and performance ratios that fail if a known quadratic returns.
