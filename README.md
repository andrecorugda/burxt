...
Every push runs **70 invariants**, including that fixpoint, the differential test, 143 pass and 273 fail fixtures, and performance ratios that fail if a known quadratic returns.
