...
Every push runs **74 invariants**, including that fixpoint, the differential test, 151 pass and 307 fail fixtures, and performance ratios that fail if a known quadratic returns.
