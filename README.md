...
Every push runs **74 invariants**, including that fixpoint, the differential test, 148 pass and 304 fail fixtures, and performance ratios that fail if a known quadratic returns.
